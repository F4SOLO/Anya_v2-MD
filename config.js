...
module.exports = {
     ...
     */
    botname: process.env.BotName || "SL BAD LAKSHAN",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 SL bad lakshaa 𝐁𝐨𝐭",
    ...
    ownernumber: process.env.Owner_Number || "94714568419",
    instagramId: process.env.Insta || "3.69_pika",

    /**
     * other details and parameters
     */
    author: process.env.Author || "laksha 🌚🌙",
    ...
    mongoUrl: process.env.MongoDB |" k",
    sessionId: process.env.SESSION_ID || "ZGdtYzJ_Queen-Anya_5OWg=",
